...
package com.sinosafe.xb.manager.utils.lianlianpay.utils;
...
public class MobileSecurePayer {
    ...
    public boolean pay(String strOrderInfo, final Handler callback,
            ...
            boolean isTest) {
    	return pay(strOrderInfo, callback, myWhat, activity, pay_product, signCard, isTest, Constants.PAY_MODE.PAY_COMMON);
    }
    ...
    public boolean pay(String strOrderInfo, final Handler callback,
            final int myWhat, final Activity activity, String pay_product, boolean signCard,
            boolean isTest, final Constants.PAY_MODE pay_mode) {
        if (mbPaying)
            return false;
        mbPaying = true;
