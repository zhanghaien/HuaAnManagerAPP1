...
public class RecyclerViewStateUtils {
     ...
     */
    public static boolean setFooterViewState(Activity instance, RecyclerView recyclerView, int pageSize, LoadingFooter.State state, View.OnClickListener errorListener) {
