package com.sinosafe.xb.manager.widget.edit;
...
/**
 * 类名称：ClearEditText.java <br>
 * 内容摘要： //自定义带删除按钮的EditText。<br>
 * 属性描述：<br>
 * 方法描述：<br>
 * 修改备注：   <br>
 * 创建时间： 2016年4月24日下午3:28:01<br>
 * 公司：深圳市华移科技股份有限公司<br>
 * @author Mr 张<br>
 */
public class ClearEditText extends EditText implements OnFocusChangeListener,
	...
	private void init() {
		...
		if (mClearDrawable == null) {
			mClearDrawable = getResources().getDrawable(R.mipmap.icon_delete_img);
		}

		mClearDrawable.setBounds(0, 0, mClearDrawable.getIntrinsicWidth(),
				mClearDrawable.getIntrinsicHeight());
		setPadding(15, 0, 25, 0);
		// 默认设置隐藏图标
