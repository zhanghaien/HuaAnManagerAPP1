...
public class MoneyView extends View {
    ...
    private int mMoneyColor = Color.parseColor ( "#f14434" );
    private int mPrefixColor = Color.parseColor ( "#f14434" );
    ...
    private int mPrefixPadding = dp2px ( 2 ); //小数点与分的间隔
    private int mPointPaddingLeft = dp2px ( 1 ); //小数点与分的间隔
