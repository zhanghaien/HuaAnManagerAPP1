...
import com.wheelview.adapters.WheelViewAdapter;
...
public class WheelView extends View {
     ...
     */
    private int[] SHADOWS_COLORS = new int[] { 0x2ffffff, 0x2ffffff, 0x2ffffff };
    ...
    private int calculateLayoutWidth(int widthSize, int mode) {
        ...
        itemsLayout.setBackgroundResource(R.color.white);
    ...
    private void createItemsLayout() {
        if (itemsLayout == null) {
            ...
            itemsLayout.setBackgroundResource(R.color.white);
//            itemsLayout.setBackgroundColor(R.color.white);
